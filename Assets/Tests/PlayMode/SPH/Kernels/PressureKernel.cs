...
namespace SPH
{
    ...
    public class PressureKernel
    {
        ...
        public ComputeBufferWrapperFloat ComputePressure(ComputeBufferWrapperFloat Densities, float k, float densityFactor, int NBlocks = 1_000, ComputeBufferWrapperFloat? Pressures = null)
        {
